...
install -d "$PACKAGE_DIR/var/log/peperspray"
...
install -m 0644 /dev/null "$PACKAGE_DIR/var/log/peperspray/events.jsonl"
install -m 0644 "$ROOT_DIR/packaging/systemd/pepersprayd.service" "$PACKAGE_DIR/lib/systemd/system/pepersprayd.service"
